export default{
    ...
    espa:'<p>Η παρούσα δράση χρηματοδοτήθηκε στα πλαίσια του προγράμματος ' +
    ...
    faq: {
        ...
        1:{
            ...
            content: 'Η συσκευή είναι plug and play, απλά προσκολλήστε την πάνω στο μηχάνημα και θα ξεκινήσει τη λειτουργία.'
        },
        2: {
    ...
    testimonials: {
        ...
        3:{
            ...
            content: '“Η λύση της Embneusys μας φέρνει ένα βήμα πιο κοντά στην επίτευξη της πράσινης και επιχειρησιακής απόδοσης στη βιομηχανία εξόρυξης.”'
        }
    },
    marquee:{
        title: 'ΤΕΛΕΥΤΑΙΑ ΝΕΑ',
